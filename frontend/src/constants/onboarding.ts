...
export const EXPERIENCE_OPTIONS: Option<ExperienceLevel>[] = [
  {
    value: 'beginner',
    label: 'Beginner',
    description: 'New to training or returning after a long break. e.g. never lifted weights.',
    icon: '🌱',
  },
  {
    value: 'intermediate',
    label: 'Intermediate',
    description: 'Consistent for 6+ months and comfortable with the basics. e.g. train 3x/week.',
    icon: '⚡',
  },
  {
    value: 'advanced',
    label: 'Advanced',
    description: 'Years of structured training and strong technique. e.g. tracked programming.',
    icon: '🏆',
  },
];
...
export const ONBOARDING_STRINGS = {
  ...
  steps: {
    ...
    injuries: {
      ...
      helper: 'Optional — pick from suggestions or type your own. Leave empty if none.',
